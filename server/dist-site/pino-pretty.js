...
var require_pipeline = __commonJS({
  "node_modules/pino-pretty/node_modules/readable-stream/lib/internal/streams/pipeline.js"(exports2, module2) {
    ...
    async function pump2(iterable, writable, finish, { end }) {
      let error;
      let onresolve = null;
      const resume = (err) => {
        if (err) {
...
var require_colors = __commonJS({
  "node_modules/pino-pretty/lib/colors.js"(exports2, module2) {
    "use strict";
    var { LEVELS, LEVEL_NAMES: LEVEL_NAMES2 } = require_constants();
    ...
    function colorizeLevel(useOnlyCustomProps) {
      return function(level, colorizer, { customLevels, customLevelNames } = {}) {
        ...
        const levelNames = useOnlyCustomProps ? customLevelNames || LEVEL_NAMES2 : Object.assign({}, LEVEL_NAMES2, customLevelNames);
...
// node_modules/fast-copy/dist/fast-copy.cjs.js
var require_fast_copy_cjs = __commonJS({
  "node_modules/fast-copy/dist/fast-copy.cjs.js"(exports2, module2) {
    "use strict";
...
var require_sonic_boom = __commonJS({
  "node_modules/pino-pretty/node_modules/sonic-boom/index.js"(exports2, module2) {
    "use strict";
    var fs = require("fs");
...
var require_on_exit_leak_free = __commonJS({
  "node_modules/pino-pretty/node_modules/on-exit-leak-free/index.js"(exports2, module2) {
    "use strict";
    var refs = {
      exit: [],
      beforeExit: []
...
var require_utils2 = __commonJS({
  "node_modules/pino-pretty/lib/utils.js"(exports2, module2) {
    "use strict";
    var fastCopy = require_fast_copy_cjs();
    ...
    var {
      DATE_FORMAT,
      ERROR_LIKE_KEYS: ERROR_LIKE_KEYS2,
      MESSAGE_KEY: MESSAGE_KEY2,
    ...
    module2.exports = {
      isObject: isObject2,
      prettifyErrorLog: prettifyErrorLog2,
      prettifyLevel: prettifyLevel2,
      prettifyMessage: prettifyMessage2,
      prettifyMetadata: prettifyMetadata2,
      prettifyObject: prettifyObject2,
      prettifyTime: prettifyTime2,
      buildSafeSonicBoom: buildSafeSonicBoom2,
      filterLog: filterLog2
    };
    ...
    function prettifyErrorLog2({
      log,
      messageKey = MESSAGE_KEY2,
      ident = "    ",
      eol = "\n",
      errorLikeKeys = ERROR_LIKE_KEYS2,
      errorProperties = []
    }) {
      ...
      if (errorProperties.length > 0) {
        ...
        for (let i = 0; i < propertiesToPrint.length; i += 1) {
          ...
          if (isObject2(log[key])) {
            const prettifiedObject = prettifyObject2({ input: log[key], errorLikeKeys, excludeLoggerKeys: false, eol, ident: ident + ident });
    ...
    function prettifyLevel2({ log, colorizer = defaultColorizer, levelKey = LEVEL_KEY2, prettifier, customLevels, customLevelNames }) {
    ...
    function prettifyMessage2({ log, messageFormat, messageKey = MESSAGE_KEY2, colorizer = defaultColorizer, levelLabel = LEVEL_LABEL, levelKey = LEVEL_KEY2, customLevels, useOnlyCustomProps }) {
    ...
    function prettifyMetadata2({ log, prettifiers = {} }) {
      let line = "";
    ...
    function prettifyTime2({ log, timestampKey = TIMESTAMP_KEY2, translateFormat = void 0, prettifier }) {
      let time = null;
    ...
    function filterLog2({ log, ignoreKeys, includeKeys }) {
