            ...
            <b-overlay :show="show" rounded="sm">
                <b-card bg-variant="dark" text-variant="white" title="Profile Details" v-if="user">
                    <b-card-text class="d-flex justify-content-start align-items-center">
                        ...
                        <b-button :pressed.sync="editMode" variant="primary" style="margin-left:auto" class="mb-2">Edit
                            Mode</b-button>
                    </b-card-text>
                    ...
                    <b-card-text v-else>
                        <b-form>
                            <b-form-group id="input-group-1" label="Your Name:" label-for="input-1">
                                <b-form-input id="input-1" v-model="form.name" placeholder="What is your name?"
                                    required></b-form-input>
                            </b-form-group>

                            <b-form-group id="input-group-2" label="Your Age:" label-for="input-2">
                                <b-form-input id="input-2" v-model="form.age" placeholder="What is your age"
                                    required></b-form-input>
                            </b-form-group>

                            <b-form-group id="input-group-3" label="Enter a bio:" label-for="input-3">
                                <b-form-input id="input-3" v-model="form.bio" placeholder="Tell us about yourself"
                                    required></b-form-input>
                            </b-form-group>
